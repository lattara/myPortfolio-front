(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        _createClass(BioDashboardComponent, [{
          ...
          value: function submitModifyBio() {
            ...
            this.http.post('http://188.166.59.10:3000/api/bio/upload', formDataSubmit).subscribe(function (res) {
              _this12.bioToModify.intro = _this12.modifyBioForm.value.intro;
              _this12.bioToModify.cvLink = res.data.CVname;
              _this12.bioToModify.profileImgLink = res.data.imgName;

              _this12.bioService.putBio(_this12.bioToModify, 1).subscribe(function (bio) {});
    ...
    function fsYz(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_title_title_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../../components/title/title.component */
      "bwXy");
      /* harmony import */
      ...
      var LandingComponent = /*#__PURE__*/function () {
        function LandingComponent(githubService) {
          _classCallCheck(this, LandingComponent);

          this.githubService = githubService; // tslint:disable-next-line: no-output-native
      ...
      LandingComponent.ɵfac = function LandingComponent_Factory(t) {
        return new (t || LandingComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_git_hub_service__WEBPACK_IMPORTED_MODULE_1__["GitHubService"]));
      };
      ...
      LandingComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        directives: [_components_title_title_component__WEBPACK_IMPORTED_MODULE_2__["TitleComponent"], _components_button_button_component__WEBPACK_IMPORTED_MODULE_3__["ButtonComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterLink"]],
          ...
          value: function getAllProjectsWithToolbox() {
            ...
            for (var i = 1; i < 8; i++) {
              ...
              Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["forkJoin"])([$project, $toolbox]).subscribe(function (results) {
                _this14.project = results[0];

                if (Object.keys(_this14.project).length === 0) {
                  delete _this14.project.toolbox;
                } else {
                  _this14.project.toolbox = Object.entries(results[1]).map(function (e) {
                    return e[1];
                  });

                  _this14.projects.push(_this14.project);
                }
              });
            }
          }
        ...
        _createClass(ProjectsDashboardComponent, [{
          ...
          value: function getAllProjectsWithToolbox() {
            ...
            this.projectsService.getProjects().subscribe(function (projects) {
              ...
              projects.forEach(function (project) {
                _this15.toolboxService.getToolboxItemByProjectId(project.id).subscribe(function (toolbox) {
                  toolboxArr = Object.values(toolbox);
                  project.toolbox = toolboxArr;
                });

                _this15.dataSource = new _models_projectDataSource__WEBPACK_IMPORTED_MODULE_5__["ProjectsDataSource"](_this15.projects);
              });
            });
          }
        }, {
          ...
          value: function createProject() {
            ...
            this.projectsService.postProject(this.newProject).subscribe(function (resp) {
              _this17.newProject.id = resp.id;

              _this17.getAllProjectsWithToolbox();

              _this17.newToolBoxArr.forEach(function (toolboxItem) {
                _this17.toolboxService.postToolboxItem(_this17.newProject.id, toolboxItem.id).subscribe(function () {
          ...
          value: function deleteProject(project) {
            ...
            this.projectsService.deleteProject(project.id).subscribe(function () {
              for (var i = 0; i < _this18.projects.length; i++) {
                if (_this18.projects[i].id === project.id) {
                  _this18.projects.slice(i, 1);
          ...
          value: function saveEditedProject() {
            ...
            this.projectsService.putProject(this.projectToEdit, this.idProjectToEdit).subscribe(function (result) {
              _this19.getAllProjectsWithToolbox();
            });
          } // toolbox items logic
          ...
          value: function removeToolboxItem(projectToEditId, toolboxItemId, i) {
            ...
            this.toolboxService.deleteFromToolbox(projectToEditId, toolboxItemId).subscribe(function () {
              _this20.projectToEdit.toolbox.splice(i, 1);
            });
          }
        }, {
          key: "addToolboxItem",
          value: function addToolboxItem(projectToEditId, toolboxItemId, toolboxItem) {
            ...
            this.toolboxService.postToolboxItem(projectToEditId, toolboxItemId).subscribe(function () {
              _this21.toolboxToEdit.push(toolboxItem);
            });
          }
        }, {
